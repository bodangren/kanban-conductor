...
- [x] Task: Add Pause/Resume/Cancel controls 5d176fd
  - [x] Write UI tests for control buttons
  - [x] Implement buttons that call IPC handlers
- [x] Task: Conductor - User Manual Verification 'Phase 3: UI for Scheduling Controls'
