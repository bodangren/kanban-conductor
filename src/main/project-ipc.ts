...
import {
  loadPlanDetails as loadPlanDetailsService,
  PlanDetailFileSystem,
} from './plan-detail-loader'
import {
  updatePlanContents as updatePlanContentsService,
  PlanUpdateFileSystem,
} from './plan-detail-writer'
...
export function createProjectHandlers(deps: ProjectIpcDependencies): ProjectIpcHandlers {
  ...
  const selectProject = async (): Promise<ProjectLoadResponse> => {
